    ...
    >
      ...
      <div className="w-full md:w-1/2 z-10">
        ...
        >
          ...
          >
            <a
              href="https://drive.google.com/file/d/1YNbNI4RY0xwYf2hD9GAPbSpR20jTzI1G/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center rounded-full px-6 py-2 text-sm font-medium bg-primary text-primary-foreground shadow hover:bg-primary/90 btn-hover-effect"
            >
